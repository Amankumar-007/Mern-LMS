          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Access over 150+ premium courses in {languages.length}{" "}
                languages. Start your learning journey today.
              </p>
            ...
            {[...Array(3)].map((_, index) => (
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed">
                  "The course exceeded my expectations. The content was
                  well-structured and easy to follow. I've learned so much and
                  feel confident in my new skills. The instructor was
                  excellent!"
                </p>
              </motion.div>
            ))}
